        ...
        if (username !== "guestUser") {
            modalBody.innerHTML = `
                <div class="loggedInUserModal" id="getStartedForm" data-productid="${productID}">
                    <span class="loggedInModalText">Would you like to request a demo for the product?</span>
                    <button type="button" class="btn btn-primary loggedInUserBtn" id="submitLoggedInForm">Submit</button>
                </div>
            `;
        } else {
            modalBody.innerHTML = `
